 ...
 * @since 1.0
 */
class KillarWT_Customizer_Media_Columns_Control extends KillarWT_Customizer_Base_Control {
	 ...
	 * @var string
	 */
	public $type = 'killarwt-media-columns';
	...
	public function enqueue() {
		parent::enqueue();
		wp_enqueue_script( 'killarwt-control-media-columns', KILLARWT_CUSTOMIZER_CONTROL_DIR_URI.'media-columns/media-columns.js',  array( 'jquery', 'customize-base', 'killarwt-base-control' ), KILLARWT_VERSION, true );
		wp_enqueue_style( 'killarwt-control-media-columns-style', KILLARWT_CUSTOMIZER_CONTROL_DIR_URI.'media-columns/media-columns.css', array(), KILLARWT_VERSION );
	}
