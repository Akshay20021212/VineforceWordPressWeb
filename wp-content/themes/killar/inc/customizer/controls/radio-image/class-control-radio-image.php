 ...
 * @since 1.0
 */
class KillarWT_Customizer_Radio_Image_Control extends KillarWT_Customizer_Base_Control {
	 ...
	 * @var string
	 */
	public $type = 'killarwt-radio-image';
	...
	public function enqueue() {
		parent::enqueue();
		wp_enqueue_script( 'killarwt-control-radio-image', KILLARWT_CUSTOMIZER_CONTROL_DIR_URI.'radio-image/radio-image.js',  array( 'jquery', 'customize-base', 'killarwt-base-control' ), KILLARWT_VERSION, true );
		wp_enqueue_style( 'killarwt-control-radio-image-style', KILLARWT_CUSTOMIZER_CONTROL_DIR_URI.'radio-image/radio-image.css', array(), KILLARWT_VERSION );
	}
