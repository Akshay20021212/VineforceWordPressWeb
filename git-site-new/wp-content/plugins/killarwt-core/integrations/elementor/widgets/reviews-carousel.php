...
class KillarWT_Elementor_ReviewsCarousel extends KillarWT_Elementor_Widget_Base {
	
	public function __construct($data = [], $args = null) {
      parent::__construct($data, $args);

      wp_register_script( 'kwt-reviews-carousel-handle', KILLAR_ELEXTS_URL . 'assets/js/reviews-carousel.js', [ 'elementor-frontend' ], KILLARWT_CORE_VERSION, true );
   	}
	
	public function get_name() {
		return 'killar-reviews-carousel';
	}
	
	public function get_title() {
		return __( 'Reviews Carousel', 'killarwt-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Reviews Carousel', 'killarwt-core' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'reviews-style3' => esc_html__( 'Style - 3', 'killarwt-core' ),
					'reviews-style4' => esc_html__( 'Style - 4', 'killarwt-core' ),
				],
				'default' => 'review-1',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'col-xl-4 col-lg-5 col-md-6 col-sm-10 col-12 m-auto',
			]
		);
		...
		// Icon Style -------------------------------
		$this->killarwt_style_icon_controls( array('tab_condition' => ['condition' => ['icon_type!' => '']], 'el_classes' => 'mb-0' ) );
	...
	protected function render() {
		...
		echo killarwt_reviews_carousel( $settings );
		
	}
	
	public function get_script_depends() {
		if( is_user_logged_in() ) return [ 'kwt-global', 'kwt-reviews-carousel-handle' ];
		return [];
	}
}
$widgets_manager->register_widget_type( new KillarWT_Elementor_ReviewsCarousel() );