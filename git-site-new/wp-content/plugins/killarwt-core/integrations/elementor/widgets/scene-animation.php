...
class KillarWT_Elementor_SceneAnimation extends KillarWT_Elementor_Widget_Base {
	...
	public function get_name() {
		return 'killar-scene-animation';
	}
	
	public function get_title() {
		return __( 'Scene Animation', 'killarwt-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_Gallery',
			[
				'label' => esc_html__( 'Items', 'killarwt-core' ),
			]
		);
		...
		// General Style -------------------------------
		$this->killarwt_style_general_controls( array( 'el_classes' => 'killar-scene-animation w-100' ) );
	}
	
	protected function render() {
		
		$settings = $this->get_settings();
		echo killarwt_scene_animation( $settings );
...
$widgets_manager->register_widget_type( new KillarWT_Elementor_SceneAnimation() );