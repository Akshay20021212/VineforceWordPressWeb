...
class KillarWT_Elementor_Counter extends KillarWT_Elementor_Widget_Base {
	
	public function __construct($data = [], $args = null) {
      parent::__construct($data, $args);

      wp_register_script( 'kwt-counter', KILLAR_ELEXTS_URL . 'assets/js/counter.js', [ 'elementor-frontend' ], KILLARWT_CORE_VERSION, true );
   	}
	
	public function get_name() {
		return 'killar-icon-box';
	}
	
	public function get_title() {
		return __( 'Counter', 'killarwt-core' );
	}
	
	public function get_icon() {
		return 'killar-icon eicon-counter';
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_counter',
			[
				'label' => esc_html__( 'Counter', 'killarwt-core' ),
			]
		);
		...
		$this->add_control(
			'counter_number',
			[
				'label' => esc_html__( 'Number', 'killarwt-core' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Number Prefix', 'killarwt-core' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Number Sufix', 'killarwt-core' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Animation Duration', 'killarwt-core' ),
				'type' => Controls_Manager::NUMBER,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			'sufix_color',
			[
				'label' => __( 'sufix Color', 'killarwt-core' ),
		...
		$this->add_control(
			'prefix_color',
			[
				'label' => __( 'prefix Color', 'killarwt-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => array_flip(killarwt_color_array()),
			]
		...
		// Counter Style -------------------------------
		$this->killarwt_style_fields_controls( 'counter_num', array( 'label' => 'Counter Number', 'class'=> '.bx-counter', 'size' => 'h3' ) );
	...
	protected function render() {
		...
		echo killarwt_counter( $settings );
	}
	
	public function get_script_depends() {
		if( is_user_logged_in() ) return [ 'kwt-global', 'kwt-counter' ];
		return [];
	}
}
$widgets_manager->register_widget_type( new KillarWT_Elementor_Counter() );