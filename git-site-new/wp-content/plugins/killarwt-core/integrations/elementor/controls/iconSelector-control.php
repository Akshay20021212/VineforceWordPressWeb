...
class IconSelector_Control extends Base_Data_Control {
	...
	public function includes() {
		require_once( KILLARWT_CORE_INC_DIR.'/icons_list.php' );
	}
	...
	public function enqueue() {
		...
		$url = KILLAR_ELEXTS_URL.'assets/';
		
		wp_enqueue_style('icon-selector', $url.'/css/icon-selector.css', array(), '');
		wp_enqueue_script( 'kwt-elementor-selector', $url . 'js/selector.js', array('jquery'), KILLARWT_CORE_VERSION , true );
	}
	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div style="pading-bottom:5px;"><input type="text" class="kwt_param_icons_search" placeholder="Search..." /></div>
